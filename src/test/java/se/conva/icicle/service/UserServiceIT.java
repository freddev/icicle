...
class UserServiceIT {
    ...
    void testRemoveOldPersistentTokens() {
        ...
        Assertions.assertThat(persistentTokenRepository.findByUser(user)).hasSize(existingCount + 2);
        userService.removeOldPersistentTokens();
        Assertions.assertThat(persistentTokenRepository.findByUser(user)).hasSize(existingCount + 1);
    }
